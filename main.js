...
(function () {
  ...
  (function terminalDemo() {
    ...
    var PROJECTS = [
      ...
      { n: "Support Ticket Classifier", d: "NLP pipeline for support tickets — issue-type classification and rule-based entity extraction, served via a Gradio app. Urgency scored at chance and is reported, not claimed.", t: ["Python", "scikit-learn", "NLTK", "Gradio"], tools: ["Python", "scikit-learn", "NLTK", "Gradio"], dom: ["ML", "NLP"], code: "https://github.com/VishnujanNarayanan/ticket-classifier-nlp", img: "images/flow/ml-analysis.jpg" },
