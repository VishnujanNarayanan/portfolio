...
(function () {
  ...
  (function terminalDemo() {
    ...
    var PROJECTS = [
      ...
      { n: "Age & Gender Classifier", d: "Multi-task CNN predicting age and gender from a face photo, trained on 10,000+ UTKFace images with face detection and alignment.", t: ["Python", "TensorFlow", "Keras", "OpenCV"], tools: ["Python", "TensorFlow", "Keras", "OpenCV"], dom: ["ML", "Computer Vision"], code: "https://github.com/VishnujanNarayanan/Image_classifier", img: "images/projects/age-gender-poster.jpg" },
